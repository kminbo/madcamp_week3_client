...
import { saveProgress } from '../../api/progressApi'; // ✅ API 호출 함수 추가
        ...
        >
            ...
            <div className="w-1/4 text-white flex flex-col items-center justify-center p-8 space-y-6">
                ...
                <ul className="space-y-4 text-lg">
                    <li className="font-bold bg-black bg-opacity-60 text-white px-2 py-1 rounded-md">
                        1. 감사의 방
                    </li>
                    <li>2. 반성의 방</li>
                    <li>3. '나'의 방</li>
